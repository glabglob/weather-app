...
export const currentWeatherFetchedError = createAction('CURRENT_WEATHER_FETCHING_ERROR');



export const forecastFetching = createAction('FORECAST_FETCHING');
export const forecastFetched = createAction('FORECAST_FETCHED');
export const forecastFetchedError = createAction('FORECAST_FETCHING_ERROR');
